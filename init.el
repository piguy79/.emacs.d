...
(add-to-list 'package-pinned-packages '(clojure-mode . "melpa") t)
(add-to-list 'package-pinned-packages '(magit . "melpa") t)
(add-to-list 'package-pinned-packages '(magit-popup . "melpa") t)
(add-to-list 'package-pinned-packages '(paredit . "melpa") t)
(add-to-list 'package-pinned-packages '(clojure-mode-extra-font-locking . "melpa") t)
